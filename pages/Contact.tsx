                    ...
                    <div>
                        ...
                        <div className="bg-dark-800 p-6 rounded-xl border border-gray-800 space-y-6">
                            ...
                            <div>
                                ...
                                <a href="https://maps.app.goo.gl/iv6NrqiqWXmVCpJC8" target="_blank" rel="noopener noreferrer" className="text-orange-500 text-xs mt-2 inline-block underline hover:text-orange-400">{t('contact.viewMap')}</a>
                            </div>
                            ...
                            <div className="border-t border-gray-700 pt-6">
                                ...
                                <a href="https://maps.app.goo.gl/eoEzG6N9nu6NJPfh9" target="_blank" rel="noopener noreferrer" className="text-orange-500 text-xs mt-2 inline-block underline hover:text-orange-400">{t('contact.viewMap')}</a>
                            </div>
                    ...
                    <div className="bg-dark-800 rounded-xl border border-gray-800 overflow-hidden">
                        ...
                        <div className="h-64 bg-gray-700 relative">
                             ...
                             <div className="absolute inset-0 flex items-center justify-center">
                                <a href={activeLoc === 'montfleuri' ? "https://maps.app.goo.gl/iv6NrqiqWXmVCpJC8" : "https://maps.app.goo.gl/eoEzG6N9nu6NJPfh9"} target="_blank" rel="noopener noreferrer" className="text-center group cursor-pointer hover:scale-110 transition-transform">
