...
const translations = {
  en: {
    ...
    'home.test.desc': 'Take our professional language test to discover your English proficiency level from A1 to C2. 95 questions, 60 minutes, instant results.',
  ...
  ar: {
    ...
    'home.test.desc': 'قم بإجراء اختبار اللغة الاحترافي الخاص بنا لاكتشاف مستواك في اللغة الإنجليزية من A1 إلى C2. 95 سؤالاً، 60 دقيقة، نتائج فورية.',
