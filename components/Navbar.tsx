...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed w-full z-50 transition-all duration-300 border-b border-transparent ${isScrolled || isOpen ? 'bg-[#0f0f0f]/95 backdrop-blur-md border-white/5 py-3' : 'bg-transparent py-4 md:py-6'}`}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 bg-dark-900 z-40 lg:hidden flex flex-col pt-28 pb-10 px-6 overflow-y-auto h-[100dvh]"
          >
